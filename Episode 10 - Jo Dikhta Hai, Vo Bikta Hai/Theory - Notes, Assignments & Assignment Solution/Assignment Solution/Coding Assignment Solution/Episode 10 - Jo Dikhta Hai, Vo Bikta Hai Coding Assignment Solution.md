...
<html lang="en">
  ...
  <body>
    ...
    <script
      type="module"
      src="./Episode 10 - Jo Dikhta Hai, Vo Bikta Hai/Theory - Notes, Assignments & Assignment Solution/Assignment Solution/Coding Assignment Solution/App.js"
    ></script>
  </body>
</html>
```
...
const RestaurantCard = ({
  ...
  return (
    <Link
      to={"/restaurants/" + id}
      className="w-[250px] h-[300px] bg-[#fff] rounded-[8px] shadow-md cursor-pointer overflow-hidden hover:scale-[0.98]"
    >
      <img
