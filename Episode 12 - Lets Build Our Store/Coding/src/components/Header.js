    ...
    <div className="w-screen h-20 flex justify-between items-center text-[#545454] px-6 py-0 bg-[#ffffff] shadow-[-2px_7px_5px_-6px_#0000009c] font-bold fixed top-0 left-0 z-[999]">
      ...
      <div>
        <ul className="list-none flex items-center">
          ...
          <li>
            <Link
              className={`flex justify-center items-center px-2 cursor-pointer text-inherit hover:text-white hover:bg-[#E46F20] hover:rounded-[5px] ${cartItems.length === 0 ? 'py-2' : 'py-0'}`}
              to="/cart"
            >
              <FaCartArrowDown />
              {cartItems.length > 0 && (
